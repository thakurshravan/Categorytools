...
async def read_index():
    ...
    """
    # Replace the Jinja2 template placeholders with empty targets for the initial load
    html_content = get_base_html()
    
    # We clean up Jinja syntax structures to empty strings for the initial load
...
async def download_report():
    ...
    return HTMLResponse(content="<h3>Error: No calculation data found in workspace memory cache. Run an analysis line first.</h3>", status_code=400)import io
import os
import pandas as pd
from fastapi import FastAPI, UploadFile, File, Request
from fastapi.responses import HTMLResponse, StreamingResponse
